...
# F. heteroclitus MDPP vs. MDPL: all treatments combined
...
```{r echo=TRUE}
condition = factor(c("MDPL","MDPL","MDPL","MDPL","MDPL","MDPL","MDPL","MDPL","MDPL","MDPP","MDPP","MDPP","MDPP","MDPP","MDPP","MDPP","MDPP","MDPP"))
...
```{r echo=TRUE}
res<-results(dds,contrast=c("condition","MDPL","MDPP"))
head(res)
...
res_ordered<-res_ordered[,c(1,26,2:25)]
write.csv(res_ordered, file="Fhet_MDPL_v_MDPP_DESeq2_all.csv" )
```
...
write.csv(resSig,file="Fhet_MDPL_v_MDPP_DESeq_padj0.05_log2FC1.csv")
...
write.csv(up_down_FC,file="Fhet_DESeq_MDPL_v_MDPP_padj0.01_updownlogFC2.csv")
dim(up_down_FC)
d<-up_down_FC
d<-na.omit(d)
dim(d)
...
heatmap.2(d, main="MDPL vs. MDPP (padj<0.01, log2FC = ±2)", 

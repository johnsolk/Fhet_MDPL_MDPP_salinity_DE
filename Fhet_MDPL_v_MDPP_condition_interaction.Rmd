...
write.csv(res_ordered, file="Fhet_MDPL_v_MDPP_condition_interaction_DESeq2_all.csv" )
```
...
write.csv(resSig,file="Fhet_MDPL_v_MDPP_condition_interaction_DESeq_padj0.05_log2FC1.csv")

...
colnames(all_merged)<-c("GeneID","Name","baseMean.FW_BW.pop","log2FoldChange.FW_BW.pop","lfcSE.FW_BW.pop","stat.FW_BW.pop","pvalue.FW_BW.pop","padj.FW_BW.pop","baseMean.FW_BW.condition","log2FoldChange.FW_BW.condition","lfcSE.FW_BW.condition","stat.FW_BW.condition","pvalue.FW_BW.condition","padj.FW_BW.condition","baseMean.FW_BW.interaction","log2FoldChange.FW_BW.interaction","lfcSE.FW_BW.interaction"          "stat.FW_BW.interaction"          
[19] "pvalue.FW_BW.interaction"         "padj.FW_BW.interaction"           "MDPL_BW_1"                       
[22] "MDPL_BW_2"                        "MDPL_BW_3"                        "MDPL_FW_1.x"                     
[25] "MDPL_FW_2.x"                      "MDPL_FW_3.x"                      "MDPP_BW_1"                       
[28] "MDPP_BW_2"                        "MDPP_BW_3"                        "MDPP_FW_1.x"                     
[31] "MDPP_FW_2.x"                      "MDPP_FW_3.x"                      "Name.y"                          
[34] "baseMean.TR_FW.pop"               "log2FoldChange.TR_FW.pop"         "lfcSE.TR_FW.pop"                 
[37] "stat.TR_FW.pop"                   "pvalue.TR_FW.pop"                 "padj.TR_FW.pop"                  
[40] "baseMean.TR_FW.condition"         "log2FoldChange.TR_FW.condition"   "lfcSE.TR_FW.condition"           
[43] "stat.TR_FW.condition"             "pvalue.TR_FW.condition"           "padj.TR_FW.condition"            
[46] "baseMean.TR_FW.interaction"       "log2FoldChange.TR_FW.interaction" "lfcSE.TR_FW.interaction"         
[49] "stat.TR_FW.interaction"           "pvalue.TR_FW.interaction"         "padj.TR_FW.interaction"          
[52] "MDPL_FW_1.y"                      "MDPL_FW_2.y"                      "MDPL_FW_3.y"                     
[55] "MDPL_transfer_1"                  "MDPL_transfer_2"                  "MDPL_transfer_3"                 
[58] "MDPP_FW_1.y"                      "MDPP_FW_2.y"                      "MDPP_FW_3.y"                     
[61] "MDPP_transfer_1"                  "MDPP_transfer_2"                  "MDPP_transfer_3")
```
...
write.csv(resSig,file="Fhet_FW_transfer_interactiononly_DESeq_padj0.05_log2FC1.csv")
# MA plot with gene names
plot(log2(res_ordered$baseMean), res_ordered$log2FoldChange, col=ifelse(res_ordered$padj < 0.05, "red","gray67"),main="population:condition interaction (padj<0.05, log2FC = ±1)",xlim=c(1,20),pch=20,cex=1,ylim=c(-12,12))
...
write.csv(up_down_FC,file="Fhet_FW_transfer_interactiononly_padj0.05_updownlogFC.csv")
dim(up_down_FC)
d<-up_down_FC
d<-na.omit(d)
dim(d)
...
heatmap.2(d, main="population:condition (padj<0.05, log2FC = ±1)", 
